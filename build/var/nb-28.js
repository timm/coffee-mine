(function() {
  ...
  Nb = (function() {
    ...
    Nb.prototype.readData = function(row, cells) {
      var h, klass, value, _i, _len, _ref, _results;
      if (cells.length >= this.head.length) {
        klass = cells[this.theKlass.pos];
        _ref = this.head;
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          h = _ref[_i];
          _results.push(!this.missingp((value = cells[h.pos])) ? (value = h.prep(value), h.add(value, klass)) : void 0);
        }
        return _results;
      }
    };
  ...
  getFileAsLines('data/weather.arff', function(lines) {
    var col, nb, _i, _len, _ref, _results;
    nb = new Nb(lines);
    _ref = nb.head;
    _results = [];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
