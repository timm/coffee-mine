(function() {
  var Bins, BootStrap, Distribution, Normal, R, Rand, any, d2, d3, d4, e, inf, ln, main, ninf, normal, nummat, pi, pow, show, shuffle, sqrt;
  ...
  BootStrap = (function() {
    ...
    BootStrap.prototype.main = function() {
      var asl, bigger, i, j, tobs, tstar, yhat, ystar, zhat, zstar, _ref;
      ...
      for (j = 1, _ref = this.b; 1 <= _ref ? j <= _ref : j >= _ref; 1 <= _ref ? j++ : j--) {
        ...
        tstar = this.testStatistic(ystar, zstar);
        if (tstar > tobs) {
          bigger += 1;
        }
      }
